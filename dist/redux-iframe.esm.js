...
var getStoredState = function (keys, options, verbose) {
    ...
    if (verbose === void 0) { verbose = false; }
    var storage = getStorage(options.storageType || StorageType.SESSION);
    if (storage) {
        try {
...
export { StorageType, combineState, createModuleEventSender, createParentEventSender, getParentState, getStoredState, installEventListener, installStorageWriter, makeStoreGlobal };
